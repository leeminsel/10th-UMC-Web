  ...
  return (
    <div className="h-dvh flex flex-col">
        ...
        Minsel
            ...
            <button className="px-5 py-2 text-sm font-medium bg-[#dda5e3] text-[#262626] rounded-md hover:bg-[#b2dab1] transition-all duration-200 shadow-md active:scale-95 cursor-pointer">
                로그인</button>
            <button className="px-5 py-2 text-sm font-medium bg-[#dda5e3] text-[#262626] rounded-md hover:bg-[#b2dab1] transition-all duration-200 shadow-md active:scale-95 cursor-pointer">
                회원가입</button>
            </div>  
